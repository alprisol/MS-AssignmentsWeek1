...
if __name__ == "__main__":
    ...
    if static:
        ...
        animate_satellite(
            t,
            data_log,
            f"Assignment 4/SatelliteAnimation_ra{round(params['ra'],2)}km_rp{round(params['rp'],2)}km_i{round(params['i'],2)}_omega{round(params['omega'],2)}_OMEGA{round(params['OMEGA'],2)}_q{np.round(params['q_od'],2)}_{round(t_span[1]/3600,2)}h_{n_steps}steps.gif",
        )
