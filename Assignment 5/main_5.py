...
def satellite_dynamic_loop(t, state, params):
    ...
    w_ob_b_dot = attitude_dyanamics(
        J, q_ob, w_ob_b, w_io_i, w_io_i_dot, R_i_o_quaternion, tau_d_b, tau_p_b
    )
...
if __name__ == "__main__":
    ...
    # Comparison of Rotation matrices
    for i in range(10):

        print(data_log["R_i_o_normal"][i])
        print(data_log["R_i_o_quaternion"][i])
        print()
